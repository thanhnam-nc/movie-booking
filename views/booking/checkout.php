        ...
        <form method="POST" class="checkout-grid">
            ...
            <div class="checkout-right card-panel">
                <div class="summary-card summary-checkout-card">
                    ...
                    <div class="summary-top-card">
                        <div class="summary-poster" style="background-image:url('<?php echo htmlspecialchars(preg_match('/^(?:https?:\/\/|\/)/', trim($tickets[0]['poster_url'] ?? '')) ? trim($tickets[0]['poster_url'] ?? '') : 'assets/images/' . ltrim(trim($tickets[0]['poster_url'] ?? ''), '/')); ?>')"></div>
