            ...
            <div class="booking-right card-panel">
                <div class="summary-card">
                    <div class="summary-movie-card">
                        <div class="summary-poster" style="background-image:url('<?php echo htmlspecialchars(preg_match('/^(?:https?:\/\/|\/)/', trim($movie['poster_url'] ?? '')) ? trim($movie['poster_url']) : 'assets/images/' . ltrim(trim($movie['poster_url'] ?? ''), '/')); ?>')"></div>
                    ...
                    <button type="submit" class="btn btn-primary btn-full">Xác nhận đặt vé</button>
                </div>
            </div>
        </form>
    </div>
